...
//
describe('navigating by scroll (handsontable enabled all modules) - rowHeaders: true, colsHeader: true', function() {
  var TEST_DESC = 'enabled_all_modules/navigating/';
  var hotOptions = {
    rowHeaders: true,
    colHeader: true
  ...
  it('scroll down on main table (from cell 20, 20)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-down-from-cell-20-20-ht_master-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(20, 20);" +
  ...
  it('scroll down on top overlay (from cell 20, 20)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-down-from-cell-20-20-ht_clone_top-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(20, 20);" +
  ...
  it('scroll down on left overlay (from cell 20, 20)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-down-from-cell-20-20-ht_clone_left-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(20, 20);" +
  ...
  it('scroll down on main table (from cell 500, 500)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-down-from-cell-500-500-ht_master-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(500, 500);" +
  ...
  it('scroll down on top overlay (from cell 500, 500)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-down-from-cell-500-500-ht_clone_top-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(500, 500);" +
  ...
  it('scroll down on left overlay (from cell 500, 500)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-down-from-cell-500-500-ht_clone_left-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(500, 500);" +
  ...
  it('scroll right on main table (from cell 20, 20)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-right-from-cell-20-20-ht_master-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(20, 20);" +
  ...
  it('scroll right on top overlay (from cell 20, 20)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-right-from-cell-20-20-ht_clone_top-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(20, 20);" +
  ...
  it('scroll right on left overlay (from cell 20, 20)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-right-from-cell-20-20-ht_clone_left-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(20, 20);" +
  ...
  it('scroll right on main table (from cell 500, 500)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-right-from-cell-500-500-ht_master-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(500, 500);" +
  ...
  it('scroll right on top overlay (from cell 500, 500)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-right-from-cell-500-500-ht_clone_top-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(500, 500);" +
  ...
  it('scroll right on left overlay (from cell 500, 500)', function(done) {
    utils.openPage(utils.PAGE_DISABLED_PLUGINS, hotOptions).then(function(url) {
      utils.runBenchmark({
        reportPath: TEST_DESC + 'scroll-right-from-cell-500-500-ht_clone_left-rowH-colsH',
        url: url,
        onBefore: function() {
          browser.executeScript(
            "hot.selectCell(500, 500);" +
